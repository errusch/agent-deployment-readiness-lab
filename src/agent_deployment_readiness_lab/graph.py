...
def build_graph():
    ...
    builder.add_node("load_and_validate_request", load_and_validate_request)
    ...
    builder.add_edge(START, "load_and_validate_request")
    builder.add_edge("load_and_validate_request", "ingest_and_analyze_workflow")
